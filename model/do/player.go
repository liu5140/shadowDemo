...
func (player *Player) GetPassword() string {
	return player.LoginPassword
}
func (player *Player) IsAccountExpired() bool {
	return player.State == model.Deleted
}
func (player *Player) IsAccountLocked() bool {
	return player.State == model.Frozen
}
func (player *Player) IsCredentialsExpired() bool {
	return false
}
